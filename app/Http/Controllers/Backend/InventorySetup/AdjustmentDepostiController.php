...
class AdjustmentDepostiController extends Controller
{
     ...
     */
    public function __construct(AdjustService $adjustService, GeneralTransformer $transformer)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('backend_extra_path.pages.inventories.adjust.deposit.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('backend_extra_path.pages.inventories.adjust.deposit.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('backend_extra_path.pages.inventories.adjust.deposit.edit', get_defined_vars());
    }
