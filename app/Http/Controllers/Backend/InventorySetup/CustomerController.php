...
class CustomerController extends Controller
{
     ...
     */
    public function __construct(CustomerService $customerService, GeneralTransformer $transformer)
    {
    ...
    {
        $title = 'Customer List';
        return view('backend_extra_path.pages.customer.index', get_defined_vars());
    }
    ...
    public function edit($id)
    {
        ...
        $title = 'Add New Customer';
        return view('backend_extra_path.pages.customer.edit', get_defined_vars());
    }
