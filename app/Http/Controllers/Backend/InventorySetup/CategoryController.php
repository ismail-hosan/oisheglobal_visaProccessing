...
class CategoryController extends Controller
{
     ...
     * @param CategoryService $systemTransformer
     */
    public function __construct(CategoryService $categoryService, GeneralTransformer $transformer)
    {
    ...
    public function index(Request $request)
    {
        ...
        $title = 'Category List';
        return view('backend_extra_path.pages.category.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        $category = $this->systemService->getAllList();

        $products = Product::latest()->get();
        $product_model = "App\Models\Product";
        // dd(get_defined_vars());
        return view('backend_extra_path.pages.category.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $title = 'Add New Category';
        return view('backend_extra_path.pages.category.edit', get_defined_vars());
    }
