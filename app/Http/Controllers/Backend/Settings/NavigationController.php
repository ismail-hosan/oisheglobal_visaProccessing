...
class NavigationController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($navigation);
        return view('backend_extra_path.setup.index', get_defined_vars());
    }
    ...
    {
        $navigation = Navigation::all();
        return view('backend_extra_path.setup.create', get_defined_vars());
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend_extra_path.setup.edit', get_defined_vars());
    }
