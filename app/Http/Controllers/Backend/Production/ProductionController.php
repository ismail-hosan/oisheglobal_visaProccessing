...
class ProductionController extends Controller
{
     ...
     */
    public function __construct(ProductionService $ProductionService, GeneralTransformer $transformer)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('backend_extra_path.pages.production.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('backend_extra_path.pages.production.create', get_defined_vars());
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('backend_extra_path.pages.production.invoice', get_defined_vars());
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend_extra_path.pages.production.edit', get_defined_vars());
    }
