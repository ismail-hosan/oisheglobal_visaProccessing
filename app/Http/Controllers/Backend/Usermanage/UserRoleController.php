...
class UserRoleController extends Controller
{
     ...
     */
    public function __construct(BranchService $branchService, UserRoleService $userRoleService, GeneralTransformer $transformer)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('backend_extra_path.pages.usermanage.userRole.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('backend_extra_path.pages.usermanage.userRole.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $branch = $this->branchService->getAllBranch();
        $userRole = $this->systemService->getNavigation();
        return view('backend_extra_path.pages.usermanage.userRole.edit', get_defined_vars());
    }
