...
class UserController extends Controller
{
     ...
     */
    public function __construct(UserRoleService $userRoleService, UserService $userService, GeneralTransformer $transformer)
    {
    ...
    {
        $title = 'users List';
        return view('backend_extra_path.pages.usermanage.users.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('backend_extra_path.pages.usermanage.users.create', get_defined_vars());
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend_extra_path.pages.usermanage.users.edit', get_defined_vars());
    }
