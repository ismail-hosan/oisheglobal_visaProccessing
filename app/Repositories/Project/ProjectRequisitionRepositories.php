...
class ProjectRequisitionRepositories
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $projectrequisition->total_qty = array_sum($request->qty);
            $projectrequisition->unitprice_price = array_sum($request->unitprice);
            $projectrequisition->total_price = array_sum($request->total);
