...
class UpazilaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($upazilas as $key => $value) :
            ...
            $upazila = new Upazila();
            $upazila->district_id = $value['district_id'];
            $upazila->name = $value['name'];
            $upazila->bn_name = $value['bn_name'];
            $upazila->url = $value['url'];
            $upazila->updated_by = 1;
            $upazila->created_by = 1;
            $upazila->deleted_by = 1;
            // $upazila->deleted_at = $faker->dateTime($unixTimestamp);
            $upazila->save();
        endforeach;
    }
}
