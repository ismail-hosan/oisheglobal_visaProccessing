        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-compact" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{ route('visa.data.first') }}" class="nav-link">
                        <i style="color: rgb(9, 250, 101)" class="fas fa-border-all"></i>
                        <p>
                            Application Form
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('agent.application-list.index') }}" class="nav-link">
                        <i style="color: rgb(9, 250, 101)" class="fas fa-border-all"></i>
                        <p>
                            Application List
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('inventorySetup.customer.index') }}" class="nav-link">
                        <i style="color: rgb(9, 250, 101)" class="fas fa-border-all"></i>
                        <p>
                            Customer List
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('application-data-user.index') }}" class="nav-link">
                        <i style="color: rgb(9, 250, 101)" class="fas fa-border-all"></i>
                        <p>
                           Application List
                        </p>
