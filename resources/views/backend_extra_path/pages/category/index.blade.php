        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('inventorySetup.category.index') }}">Menu</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Menu List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.category.script')
@endsection