        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('career.index') }}">Career
                            List</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Career</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if (helper::roleAccess('career.index'))
                    <a class="btn btn-default" href="{{ route('career.index') }}"><i class="fa fa-list"></i>
                        career List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('career.store') }}" novalidate
                    ...
                    <div class=" form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="employment_status" class="form-control"
                                placeholder="employment_status" value="{{ old('employment_status') }}">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="alt" class="form-control" id="alt"
                                placeholder="Image Alternative Text" value="{{ old('meta') }}">
                            @error('alt')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
