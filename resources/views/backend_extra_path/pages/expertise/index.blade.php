        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('expertises.expertises.index') }}">Expertise</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Expertise List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Expertise List</h3>
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.expertise.script')
@endsection