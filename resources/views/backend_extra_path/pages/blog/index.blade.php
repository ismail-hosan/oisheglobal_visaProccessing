        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Blog List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-default" href="{{ route('blog.create') }}"><i class="fas fa-plus"></i>Add
                        New</a>
                    @endif
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.blog.script')
@endsection