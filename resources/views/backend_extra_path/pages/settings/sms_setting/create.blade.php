        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('settings.sms_setting.index') }}">SMS Setting List</a>
                    </li>
                    @endif
                    <li class="breadcrumb-item active"><span>Add New SMS Setting</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Add New SMS Setting</h3>
                <div class="card-tools">
                    @if(helper::roleAccess('settings.sms_setting.index'))
                    <a class="btn btn-default" href="{{ route('settings.sms_setting.index') }}"><i
                            class="fa fa-list"></i>
                        @endif
                        SMS Setting List</a>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('settings.sms_setting.store') }}"
                    novalidate>
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="api_secret" class="form-control" id="validationCustom02"
                                placeholder="Secret	" value="{{ old('api_secret') }}" required>
                            @error('api_secret')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="sender_mobile" class="form-control" id="validationCustom01"
                                placeholder="Mobile" value="{{ old('sender_mobile') }}" required>
                            @error('sender_mobile')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Salea * :</label>
                            <input type="text" name="sales" class="form-control" id="validationCustom01"
                                placeholder="Sales" value="{{ old('sales') }}" required>
                            @error('sales')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="purchases" class="form-control" id="validationCustom01"
                                placeholder="Purchases" value="{{ old('purchases') }}" required>
                            @error('purchases')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="payment_voucher" class="form-control" id="validationCustom01"
                                placeholder=" Payment Voucher" value="{{ old('payment_voucher') }}" required>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="receive_voucher" class="form-control" id="validationCustom01"
                                placeholder="Receive Voucher" value="{{ old('receive_voucher') }}" required>
