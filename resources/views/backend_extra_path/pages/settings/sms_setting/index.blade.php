        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('settings.sms_setting.index') }}">SMS Setting Setup</a>
                    </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-default" href="{{ route('settings.sms_setting.create') }}"><i
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.settings.sms_setting.script')
@endsection