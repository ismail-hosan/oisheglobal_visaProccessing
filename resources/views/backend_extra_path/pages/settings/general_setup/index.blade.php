        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('settings.general_setup.index') }}">General Setup</a>
                    </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-default" href="{{ route('settings.general_setup.create') }}"><i
                    ...
                    <table id="systemDatatable" class="display table-hover table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Timezone</th>
                                <th>Dateformat</th>
                                <th>Decimal Separate</th>
                                <th>Thousand Separate</th>
                                <th>Status</th>
                                <th>Action</th>
                            </tr>
                        </thead>
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.settings.general_setup.script')
@endsection