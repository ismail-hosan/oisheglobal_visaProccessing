        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('settings.general_setup.index') }}">General Setup
                            List</a></li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('settings.general_setup.index'))
                    <a class="btn btn-default" href="{{ route('settings.general_setup.index') }}"><i
                            class="fa fa-list"></i>
                        @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('settings.general_setup.store') }}"
                    novalidate>
                    @csrf
                    <div class="form-row">
