        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Currency</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('settings.currency.index'))
                    <a class="btn btn-default" href="{{ route('settings.currency.index') }}"><i class="fa fa-list"></i>
                        Currency List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('settings.currency.store') }}" novalidate>
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="currency_symbol" class="form-control" id="validationCustom02"
                                placeholder="Symbol" value="{{ old('currency_symbol') }}" required>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="exchange_rate" class="form-control" id="validationCustom01"
                                placeholder="Rate" value="{{ old('Exchange Rate') }}" required>
                            @error('exchange_rate')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
