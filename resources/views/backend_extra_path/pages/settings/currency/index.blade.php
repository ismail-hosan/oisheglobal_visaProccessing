        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('settings.currency.index') }}">Currency</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Currency List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-default" href="{{ route('settings.currency.create') }}"><i
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.settings.currency.script')
@endsection