        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Edit SMPT</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">SMPT List</h3>
                <div class="card-tools">
                    @if(helper::roleAccess('settings.smpt.create'))
                    <a class="btn btn-default" href="{{ route('settings.smpt.create') }}"><i class="fas fa-plus"></i>
                        Add New</a>
                    @endif
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" method="POST" action="{{ route('settings.smpt.update',$editInfo->id) }}"
                    novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="protocol" class="form-control" id="validationCustom01"
                                placeholder="SMPT Protocol" value="{{ $editInfo->protocol }}">
                            @error('protocol')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="smtp_host" class="form-control" id="validationCustom02"
                                placeholder="Host" value="{{ $editInfo->smtp_host }}" required>
                            @error('smtp_host')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="smtp_port" class="form-control" id="validationCustom01"
                                placeholder="Port" value="{{ $editInfo->smtp_port }}" required>
                            @error('smtp_port')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input name="sender_mail" class="form-control" id="validationCustom02" placeholder="Mail"
                                value="{{ $editInfo->sender_mail }}" required>
                            @error('sender_mail')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="password" class="form-control" id="validationCustom01"
                                placeholder="Password" value="{{ $editInfo->password }}" required>
                            @error('password')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
