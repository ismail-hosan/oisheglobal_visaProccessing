        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Edit Language</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('settings.language.create'))
                    <a class="btn btn-default" href="{{ route('settings.language.create') }}"><i
                            class="fas fa-plus"></i>
                        Add New</a>
                    @endif
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" method="POST"
                    action="{{ route('settings.language.update',$editInfo->id) }}" novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom01">language Name * :</label>
                            <input type="text" name="name" class="form-control" id="validationCustom01"
                                placeholder="Language Name" value="{{ $editInfo->name }}">
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="flug" class="form-control" id="validationCustom02"
                                placeholder="Symbol" value="{{ $editInfo->flug  }}" required>
                            @error('flug')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
