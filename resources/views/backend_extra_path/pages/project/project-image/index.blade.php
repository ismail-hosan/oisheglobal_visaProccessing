    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Import/Export List</h3>
                <div class="card-tools">
                    
                    <a class="btn btn-default" href="{{ route('project.image.create') }}"><i
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.project.project-image.script')
@endsection