                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="type" id="type" class="form-control">
                                ...
                                <option value="Import" @if($projectimg->type == 'Import') selected @endif>Import</option>
                                <option value="Export" @if($projectimg->type == 'Export') selected @endif>Export</option>
                            </select>
                            @error('type')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if ($projectimg->image)
                                <img src="{{ asset('public/' . $projectimg->image) }}" width="100" alt="Current Image">
                            @endif
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control summernote" name="short_description" id="short_description" rows="5" placeholder="Write about your short description...">{{ $projectimg->short_desc ?? '' }}</textarea>
