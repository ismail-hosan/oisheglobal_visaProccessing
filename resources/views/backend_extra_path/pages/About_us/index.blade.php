        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('aboutUs.ourClient.index') }}">Coustomer
                        </a></li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('aboutUs.ourClient.create'))
                    <a class="btn btn-default" href="{{ route('aboutUs.ourClient.create') }}"><i
...
@endsection
@section('scripts')
@include('backend_extra_path.pages.About_us.script')
@endsection